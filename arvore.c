...
void retirar(Registro x, Apontador *p){ // funcao para retirar um registro da arvore
    ...
    } else if (x.chave < (*p)->registro.chave){ // caso a chave seja menor que o registro a funcao é chamada novamente com os valores de x e com o ponteiro *p apontando pra sua esquerda
        retirar(x, &(*p)->esq); return;
    } else if (x.chave > (*p)->registro.chave){ // caso a chave seja maior que o registro a funcao é chamada novamente com os valores de x e com o ponteiro *p apontando pra sua direita
